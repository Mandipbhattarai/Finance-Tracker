...
public class DeleteUi extends javax.swing.JFrame {
    ...
    public DeleteUi(int userid) {
        initComponents();
        this.id = userid;
        System.out.println("DeleteUi: "+ id);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Delete Transaction");
        ...
        jButton7.setBackground(new java.awt.Color(115, 152, 242));
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
          try {
            ...
            String transactionId = transaction_id.getText(); // Assuming transaction_id is a String
            int tid = Integer.parseInt(transactionId); // Assuming tid is an int

            String sql = "DELETE FROM transactions WHERE tid = ? AND customer_id = ?";
            pst = con.prepareStatement(sql);
            pst.setInt(1, tid); // Set the tid parameter
            pst.setInt(2, id); // Set the customer_id parameter
